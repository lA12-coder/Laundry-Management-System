...
function ToggleRow({ label, description, checked, onChange }) {
  return (
    <label className="flex cursor-pointer items-start justify-between gap-4 rounded-xl border border-gray-50 px-4 py-3 hover:bg-gray-50/80">
      <span>
      ...
      <input
        ...
        className="mt-1 h-4 w-4 rounded border-gray-300 text-[#4c84a4]"
      />
    </label>
  );
}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 pb-2 border-b border-gray-50">
        ...
        <div>
          <h2 className="text-sm font-black text-gray-900">Global operational preferences</h2>
      ...
      {isLoading ? (
        ...
        <>
          <fieldset className="space-y-2">
            <legend className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">
              Rider routing
            </legend>
            <ToggleRow
          ...
          <fieldset className="space-y-3">
            <legend className="text-[10px] font-bold text-gray-400 uppercase tracking-wider flex items-center gap-1">
