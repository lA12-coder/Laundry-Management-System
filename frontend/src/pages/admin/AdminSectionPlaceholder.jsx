...
export default function AdminSectionPlaceholder({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-gray-200 bg-white p-8 sm:p-12 text-center max-w-2xl mx-auto">
      <div className="w-14 h-14 rounded-2xl bg-[#4c84a4]/10 flex items-center justify-center mx-auto mb-5">
